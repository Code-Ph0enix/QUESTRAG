<!-- # Banking RAG Chatbot - Frontend

Modern, responsive React frontend for the Banking RAG AI Assistant with RL-enhanced retrieval.
...
- **RAG Metadata**: Display policy actions, retrieval stats, and confidence scores
- **Responsive**: Mobile-first design, works on all devices
- **Real-time Chat**: WebSocket-ready architecture (future)
